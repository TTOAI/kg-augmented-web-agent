...
- Total navigation actions (after dedup): 4034
- Unresolved target class (href 있지만 rule 미매칭): 22
- Self-edges (action stays in same class): 271
- Raw actions total: 8825
