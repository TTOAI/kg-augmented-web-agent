#!/usr/bin/env bash
# Round 2 — M1 재현 측정 (m1_repro).
#
# 측정 1(`output/measurements/m1_characterization/`, commit a34a3ac) 동결 번들의
# 재현성 검증을 위한 라운드. 원본 `run_round_2.sh`와 task/trial/env 정책 동일,
...
echo "================================================"
echo "Round 2 (m1_repro) start — $(date)"
echo "================================================"
...
echo "================================================"
echo "Round 2 (m1_repro) done — $(date)"
echo "================================================"
echo "Next: extract_signals → aggregate_cells → render_figures ($ROOT)"
